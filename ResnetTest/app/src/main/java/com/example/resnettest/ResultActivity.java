...
import com.example.resnettest.adapter.CardPagerAdapter;
import com.example.resnettest.bean.CardItem;
import com.example.resnettest.utils.ShadowTransformer;
...
public class ResultActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCardAdapter = new CardPagerAdapter(ResultActivity.this);
